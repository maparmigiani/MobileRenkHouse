...
public class Apartment extends AppCompatActivity {
    ...
    ArrayList<GetHouse> homeList = getApartments();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_apartment);
        RecyclerView recyclerView = findViewById(R.id.RecyclerApartment);
    ...
    public ArrayList<GetHouse> getApartments(){
        ArrayList<GetHouse> apartments = new ArrayList<>();
        for(GetHouse home : GetHouse.getHomeList){
            if(home.getHomeType().equals("apartment")) apartments.add(home);
        }
        return apartments;
    }
}